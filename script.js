...
<div class="cart" id="${id}">
            <div>
                <img src="${img}"
                    width="260px" height="300px" alt="loadding">
            </div>
            <div class="cart-content">
                ...
                <div class="quntity">
                    ...
                    <p id="cart-quantity">${search.item === undefined ? 0 : search.item}</p>
...
const update = (id) => {
    let search = basket.find((x) => x.id === id);
    document.getElementById(id).querySelector("#cart-quantity").innerHTML = search.item;
    Calulation();
}
